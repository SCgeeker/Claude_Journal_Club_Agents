...
# 確實未生成 Zettel 的論文 ID (排除 Paper 1 和 37 已有資料夾)
PAPER_IDS = [3, 8, 10, 13, 14, 15, 16, 18, 19, 20, 22, 25, 26, 27, 28, 29, 38, 39, 40, 41, 42, 43]
...
def main():
    ...
    # 保存結果
    import json
    result_file = Path(f"regenerate_remaining_result_{start_time.strftime('%Y%m%d_%H%M%S')}.json")
